  ...
  init: async function () {
    ...
    dishes.map(dish => {
      ...
      if (!dish.unavailable_days.includes(days[todaysDay])) {
        ...
        ratingPlane.setAttribute("material", { color : "blue"});
        ...
        rating.setAttribute("text", {
          ...
          width: 2.4,
          align: "center",
          value: `Your Rating: ${dish.last_rating}`
          
        });
        ratingPlane.appendChild(rating)
        marker.append(ratingPlane)
        ...
        reviewPlane.setAttribute("material", { color : "blue"});
        ...
        review.setAttribute("text", {
          ...
          width: 2.4,
          align: "center",
          value: `Your Review: ${dish.last_review}`
          
        });
        reviewPlane.appendChild(review)
        marker.append(reviewPlane)
